...
namespace RB28DETT\Users\Models;
...
use RB28DETT\Notifications\Traits\Notifiable;
use RB28DETT\Roles\Traits\HasRolesAndPermissions;
...
class User extends ExtendUser
{
    ...
    {
        return in_array($this->email, config('rb28dett.superadmins'));
    }
    ...
    public function avatar($size = 100)
    {
        ...
        */
        ...
        $color = Packages::installed('customization') ? \RB28DETT\Customization\Models\Customization::first()->navbar_color : '#1e87f0';
    ...
    /**
     * Return if the user have access to rb28dett.
     *
     * @return bool
     */
    public function rb28dettAccess()
    {
        return $this->hasPermission('rb28dett::access') || $this->superAdmin();
    }
}
